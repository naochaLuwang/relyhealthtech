      ...
      <Location locations={locations} />
        <Flex maxWidth={"7xl"} marginX="auto" direction={"column"} marginBottom={20} paddingX={10}>
            ...
            <p className={"text-base mt-5 leading-loose"} >
                Discover exciting career opportunities at Rely Healthcare Technologies, where we&apos;re shaping the future of healthcare. Join our innovative team and make a meaningful impact.<br /> Email your resume to <Link className={"text-textPrimary font-semibold"} href={`mailto:hr@relyhealthtech.com`}>
