  ...
  return (
    <div className=" w-full h-auto bg-backgroundColor py-10  flex lg:justify-between   items-center">
      <div className="grid grid-cols-1 lg:grid-cols-3 max-w-7xl px-8     gap-y-5 lg:gap-x-10 mx-auto  ">
        <div className="lg:w-96 w-72  h-[27rem] shadow-lg   flex flex-col py-8 space-y-4 items-center  justify-center px-8 bg-buttonColor rounded-xl">
        ...
        <div className="lg:w-96 w-72 h-[27rem] justify-center  flex flex-col py-8 space-y-4 items-center px-8 bg-buttonColor rounded-xl shadow-lg">
