...
const ClientTestimonial = () => {
  return (
    <div className="h-auto bg-backgroundColor">
      <div className="max-w-7xl px-8 py-8 lg:py-16 mx-auto">
        <div className="flex flex-col items-start">
          <p className="text-sm ml-1">OUR CLIENTS</p>
          <h1 className="lg:text-4xl  text-3xl mt-2 font-bold text-center text-primary">
            Testimonials
          </h1>
          <p className="max-w-2xl mt-5 text-justify">
            Our core values are at the heart of all that we do. They are
            integrated into our daily work lives and helps us to remember our
            customer always comes first, the last thank you should always come
            from us.
          </p>
        </div>
        <div className="mt-10">
                ...
                <div className="max-w-3xl lg:pr-8">
                  <div className="flex flex-col space-y-5">
                    <p className="font-medium  text-base text-secondary text-justify">
                      We have been using RelyHIS for more than four years and
                    ...
                    <p className="font-medium  text-base text-secondary text-justify">
                      ...
                      wasn&apos;t user friendly. With RelyHIS, the billing and
                      the workflow has become fast, and patients get the right
                      information at the right time. The management and
                      financial reports are very accurate. We are overall very
                      satisfied with the product and service.
                    </p>

                    <p className="font-medium  text-base text-secondary text-justify">
                      We are overall very satisfied with the product and
                      service.
                    </p>
                  </div>
                </div>
              </div>
              <div className="flex-col flex lg:pt-2 lg:pl-8">
                <h1 className="lg:text-xl text-lg font-bold text-primary">
                  Dr. Pramod Kr. Shrama
                </h1>
                ...
                <div className="max-w-3xl lg:pr-8">
                  <div className="flex flex-col space-y-5">
                    <p className="font-medium  text-base text-secondary text-justify">
                      ...
                      management software and the support.The software is very
                      user friendly, easily customizable and it gives clear
                      report of hospital operations. As a result, we are able to
                      make our operatons more efficient using this software.
                    </p>
                    <p className="font-medium  text-base text-secondary text-justify">
                      We truly appreciate Rely Team for customer centric
                      approach unlike many other competitors. We are proud to be
                      associated with Rely Healthcare Technologies.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:max-w-6xl mx-auto lg:h-96 h-[44rem] bg-buttonColor  justify-center  rounded-2xl shadow-lg space-y-5 flex flex-col py-8 px-8">
              <div className="flex justify-between items-center flex-col lg:flex-row space-y-8 lg:space-y-0">
                ...
                <div className="max-w-3xl lg:pr-8">
                  <div className="flex flex-col space-y-5">
                    <p className="font-medium  text-base text-secondary text-justify">
                      If you are looking for a top class software for hospital,
                      then RelyHIS Hospital Management Software is the answer.
                      It is very user friendly and helps in controlling
                      pilferage in the hospital, which is one of the top
                      challenges most hospitals face, apart from making
                      operations & process efficient.
                    </p>
                    <p className="font-medium  text-base text-secondary text-justify">
